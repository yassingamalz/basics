...
public class MoveZerosEndTest {
    ...
    @Test
    public void moveZerosEndFaster() {
        assertArrayEquals(new int[]{4, 2, 0, 0}, MoveZerosEnd.moveZerosEndFaster(new int[]{0, 0, 4, 2}));
        assertArrayEquals(new int[]{9, 4, 0, 0}, MoveZerosEnd.moveZerosEndFaster(new int[]{9, 0, 0, 4}));
        assertArrayEquals(new int[]{1, 0, 0, 0}, MoveZerosEnd.moveZerosEndFaster(new int[]{1, 0, 0, 0}));
    }
}
